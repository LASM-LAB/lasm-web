...
本文档说明如何通过编辑 `public/content/` 目录下的 Markdown 文件来更新网站内容。所有内容均采用 Markdown + YAML Frontmatter 格式存储，无需数据库。
...
> 图片存放于 `public/content/news/images/` 目录下。
...
> 视频存放于 `public/content/news/videos/` 目录下。
...
|-------------|-------------|---------------|
| `public/content/home/home.md` | `public/content/home/images/` | `/content/home/images/xxx.png` |
| `public/content/people/people.md` | `public/content/people/images/` | `/content/people/images/xxx.png` |
| `public/content/news/xxx.md` | `public/content/news/images/` | `/content/news/images/xxx.png` |
| `public/content/news/xxx.md` | `public/content/news/videos/` | `/content/news/videos/xxx.mp4` |
...
**Q: 新增新闻如何操作？**
A: 在 `public/content/news/` 下新建文件，文件名格式为 `YYYY-MM-DD-标题.md`。
